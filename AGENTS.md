...
- **Cursor rules:** [`.cursor/rules/`](.cursor/rules/) — `heartbit-core` (always); `release-homebrew` (`scripts/**`); `homebrew-cask-and-ci` (`Casks/**`); `project-yml` (`project.yml`). See [`.cursor/README.md`](.cursor/README.md).
